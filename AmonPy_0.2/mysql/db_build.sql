...
DROP SCHEMA IF EXISTS `AMON_test1` ;
CREATE SCHEMA IF NOT EXISTS `AMON_test1` DEFAULT CHARACTER SET latin1 ;
SHOW WARNINGS;
USE `AMON_test1` ;

-- -----------------------------------------------------
-- Table `AMON_test1`.`alertConfig`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `AMON_test1`.`alertConfig` ;

SHOW WARNINGS;
CREATE  TABLE IF NOT EXISTS `AMON_test1`.`alertConfig` (
  `stream` INT NOT NULL ,
  `rev` INT NOT NULL ,
...
-- -----------------------------------------------------
-- Table `AMON_test1`.`alert`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `AMON_test1`.`alert` ;

SHOW WARNINGS;
CREATE  TABLE IF NOT EXISTS `AMON_test1`.`alert` (
  ...
  CONSTRAINT `fk_alert_alertConfig1`
    ...
    REFERENCES `AMON_test1`.`alertConfig` (`stream` , `rev` )
    ON DELETE NO ACTION
    ON UPDATE CASCADE)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `AMON_test1`.`eventStreamConfig`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `AMON_test1`.`eventStreamConfig` ;

SHOW WARNINGS;
CREATE  TABLE IF NOT EXISTS `AMON_test1`.`eventStreamConfig` (
  `stream` INT NOT NULL ,
  `rev` INT NOT NULL ,
  `validStart` DATETIME NULL DEFAULT NULL ,
  `validStop` DATETIME NULL DEFAULT NULL ,
...
-- -----------------------------------------------------
-- Table `AMON_test1`.`event`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `AMON_test1`.`event` ;

SHOW WARNINGS;
CREATE  TABLE IF NOT EXISTS `AMON_test1`.`event` (
  ...
  CONSTRAINT `fk_event_eventStreamConfig1`
    ...
    REFERENCES `AMON_test1`.`eventStreamConfig` (`stream` , `rev` )
    ON DELETE NO ACTION
    ON UPDATE CASCADE)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `AMON_test1`.`skyMapEvent`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `AMON_test1`.`skyMapEvent` ;

SHOW WARNINGS;
CREATE  TABLE IF NOT EXISTS `AMON_test1`.`skyMapEvent` (
  `Dec` FLOAT NOT NULL ,
  `RA` FLOAT NOT NULL ,
  ...
  CONSTRAINT `fk_skyMapEvent_event1`
    ...
    REFERENCES `AMON_test1`.`event` (`eventStreamConfig_stream` , `id` , `rev` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `AMON_test1`.`skyMapAlert`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `AMON_test1`.`skyMapAlert` ;

SHOW WARNINGS;
CREATE  TABLE IF NOT EXISTS `AMON_test1`.`skyMapAlert` (
  `Dec` FLOAT NOT NULL ,
  `RA` FLOAT NOT NULL ,
  ...
  CONSTRAINT `fk_skyMapAlert_alert1`
    ...
    REFERENCES `AMON_test1`.`alert` (`alertConfig_stream` , `id` , `rev` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `AMON_test1`.`messenger`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `AMON_test1`.`messenger` ;

SHOW WARNINGS;
CREATE  TABLE IF NOT EXISTS `AMON_test1`.`messenger` (
  `id` INT NOT NULL ,
...
-- -----------------------------------------------------
-- Table `AMON_test1`.`source`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `AMON_test1`.`source` ;

SHOW WARNINGS;
CREATE  TABLE IF NOT EXISTS `AMON_test1`.`source` (
  `id` INT NOT NULL ,
...
-- -----------------------------------------------------
-- Table `AMON_test1`.`sourceModel`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `AMON_test1`.`sourceModel` ;

SHOW WARNINGS;
CREATE  TABLE IF NOT EXISTS `AMON_test1`.`sourceModel` (
  `id` INT NOT NULL ,
  ...
  CONSTRAINT `fk_sourceModel_messenger1`
    ...
    REFERENCES `AMON_test1`.`messenger` (`id` )
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  CONSTRAINT `fk_sourceModel_source1`
    FOREIGN KEY (`source_id` )
    REFERENCES `AMON_test1`.`source` (`id` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `AMON_test1`.`eventModel`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `AMON_test1`.`eventModel` ;

SHOW WARNINGS;
CREATE  TABLE IF NOT EXISTS `AMON_test1`.`eventModel` (
  ...
  CONSTRAINT `fk_eventModel_sourceModel1`
    ...
    REFERENCES `AMON_test1`.`sourceModel` (`id` , `messenger_id` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Table `AMON_test1`.`stream`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `AMON_test1`.`stream` ;

SHOW WARNINGS;
CREATE  TABLE IF NOT EXISTS `AMON_test1`.`stream` (
  `id` INT NOT NULL ,
...
-- -----------------------------------------------------
-- Table `AMON_test1`.`analysisConfig`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `AMON_test1`.`analysisConfig` ;

SHOW WARNINGS;
CREATE  TABLE IF NOT EXISTS `AMON_test1`.`analysisConfig` (
  ...
  CONSTRAINT `fk_alertConfig_stream1`
    ...
    REFERENCES `AMON_test1`.`stream` (`id` )
    ON DELETE CASCADE
    ON UPDATE CASCADE)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `AMON_test1`.`analysis`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `AMON_test1`.`analysis` ;

SHOW WARNINGS;
CREATE  TABLE IF NOT EXISTS `AMON_test1`.`analysis` (
  ...
  CONSTRAINT `fk_analysis_analysisConfig1`
    ...
    REFERENCES `AMON_test1`.`analysisConfig` (`stream_id` , `rev` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Table `AMON_test1`.`recipient`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `AMON_test1`.`recipient` ;

SHOW WARNINGS;
CREATE  TABLE IF NOT EXISTS `AMON_test1`.`recipient` (
  `id` INT NOT NULL ,
...
-- -----------------------------------------------------
-- Table `AMON_test1`.`distribution`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `AMON_test1`.`distribution` ;

SHOW WARNINGS;
CREATE  TABLE IF NOT EXISTS `AMON_test1`.`distribution` (
  ...
  CONSTRAINT `fk_distribution_recipient1`
    ...
    REFERENCES `AMON_test1`.`recipient` (`id` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Table `AMON_test1`.`recipient_has_stream`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `AMON_test1`.`recipient_has_stream` ;

SHOW WARNINGS;
CREATE  TABLE IF NOT EXISTS `AMON_test1`.`recipient_has_stream` (
  `recipient_id` INT NOT NULL ,
  `stream_id` INT NOT NULL ,
...
-- -----------------------------------------------------
-- Table `AMON_test1`.`follow_up`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `AMON_test1`.`follow_up` ;

SHOW WARNINGS;
CREATE  TABLE IF NOT EXISTS `AMON_test1`.`follow_up` (
  ...
  CONSTRAINT `fk_follow_up_distribution1`
    ...
    REFERENCES `AMON_test1`.`distribution` (`recipient_id` , `alert_alertConfig_stream` , `alert_id` , `alert_rev` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `AMON_test1`.`analysisConfig_has_sourceModel`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `AMON_test1`.`analysisConfig_has_sourceModel` ;

SHOW WARNINGS;
CREATE  TABLE IF NOT EXISTS `AMON_test1`.`analysisConfig_has_sourceModel` (
  `analysisConfig_stream_id` INT NOT NULL ,
  `analysisConfig_rev` TINYINT NOT NULL ,
  `sourceModel_id` INT NOT NULL ,
  `sourceModel_messenger_id` INT NOT NULL ,
...
-- -----------------------------------------------------
-- Table `AMON_test1`.`parameter`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `AMON_test1`.`parameter` ;

SHOW WARNINGS;
CREATE  TABLE IF NOT EXISTS `AMON_test1`.`parameter` (
...
-- -----------------------------------------------------
-- Table `AMON_test1`.`alertLine`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `AMON_test1`.`alertLine` ;

SHOW WARNINGS;
CREATE  TABLE IF NOT EXISTS `AMON_test1`.`alertLine` (
  `alert_alertConfig_stream` INT NOT NULL ,
  `alert_id` INT NOT NULL ,
  `alert_rev` TINYINT NOT NULL ,
  `event_eventStreamConfig_stream` INT NOT NULL ,
